// Transcrypt'ed from Python, 2019-04-18 09:55:10
...
export var Config =  __class__ ('Config', [e], {
	...
	get serializelocalstorage () {return __get__ (this, function (self) {
		getconn ().sioreq (dict ({'kind': 'serializelocalstorage', 'data': JSON.stringify (localStorage), 'owner': self.id}));
	});},
	get synclocalstorage () {return __get__ (this, function (self) {
		getconn ().sioreq (dict ({'kind': 'synclocalstorage', 'owner': self.id}));
	});},
	...
	get build () {return __get__ (this, function (self) {
		...
		self.configsplitpane.controlpanel.a ([Button ('Serialize config', self.serializeconfig).ac ('controlbutton'), Button ('Serialize localstorage', self.serializelocalstorage).ac ('controlbutton'), Button ('Sync localstorage', self.synclocalstorage).ac ('controlbutton')]);
