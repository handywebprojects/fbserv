// Transcrypt'ed from Python, 2019-04-25 09:56:00
...
export var BasicBoard =  __class__ ('BasicBoard', [e], {
	...
	get buildsquares () {return __get__ (this, function (self) {
		...
		for (var sq of self.squarelist ()) {
			...
			self.sqhdivs [sq.hashkey ()] = dict ({'div': sqhdiv, 'cumop': 0.0});
	...
	get highlightsquare () {return __get__ (this, function (self, sq, bc, op) {
		if (op == 0) {
			return ;
		}
	...
	get highlightmove () {return __get__ (this, function (self, move, bc, op) {
		self.highlightsquare (move.fromsq, bc, op);
		self.highlightsquare (move.tosq, bc, op);
	});},
	get highlightucimove () {return __get__ (this, function (self, uci, bc, op) {
